    ...
    <div className="space-y-12">
      ...
      <div className="grid lg:grid-cols-2 gap-16">
        <div className="bg-slate-950 p-12 rounded-[4rem] border border-slate-800 h-fit">
          <h2 className="text-2xl font-display font-black uppercase mb-10 text-white tracking-tight">Add <span className="text-primary">Banner</span></h2>
              ...
              {banners.map(banner => (
                <div key={banner.id} className="relative group h-48 rounded-3xl overflow-hidden border border-slate-800 shadow-lg">
                  ...
                  <div className="absolute inset-0 bg-black/60 p-6 flex flex-col justify-end">
                    ...
                    <button onClick={() => handleDelete(banner.id)} className="absolute top-4 right-4 bg-red-500/20 text-red-500 p-3 rounded-2xl hover:bg-red-500 hover:text-white transition-all">
