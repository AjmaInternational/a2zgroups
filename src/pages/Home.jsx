...
const Home = () => {
  ...
  return (
    <div className="flex flex-col w-full">
      {/* Hero Section */}
      <section className="bg-white py-10 md:py-20 px-4 md:px-10 flex flex-col md:flex-row items-center justify-between min-h-[80vh]">
        <div className="md:w-1/2 mb-10 md:mb-0">
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-primary">
            Elevate Your Style with Safranbro
          </h1>
          ...
          <Link
            to="/shop"
            className="bg-secondary text-white px-8 py-3 rounded-md text-lg font-semibold hover:bg-opacity-90 transition-all inline-block"
          >
            Shop Now
          </Link>
        </div>
      ...
      {/* Wave from Hero (white) to Promo (teal) */}
      <WaveDivider color="#149494" backgroundColor="white" />

      {/* Promotional Products */}
      <section className="bg-secondary py-20 px-4 md:px-10">
      ...
      {/* Wave from Promo (teal) to New Arrivals (white) */}
      <WaveDivider color="white" backgroundColor="#149494" />

      {/* New Arrivals Section */}
      <section className="bg-white py-20 px-4 md:px-10">
        <div className="max-w-7xl mx-auto text-center">
          <h3 className="text-secondary font-bold uppercase tracking-widest mb-2">Just Landed</h3>
          <h2 className="text-4xl md:text-5xl font-black text-primary mb-12">NEW ARRIVALS</h2>

          <Link
            to="/shop"
            className="inline-block text-secondary font-bold border-b-2 border-secondary mb-12 hover:text-primary hover:border-primary transition-colors"
          >
      ...
      {/* Final Wave to Footer (white to primary) */}
      <WaveDivider color="#002147" backgroundColor="white" />
    </div>
  );
};
